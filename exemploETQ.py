#----------------------------------------------------------------------------#
#            Exemplo de uso da Biblioteca ACBrLibETQ em Python               #
# ACBrLib é uma biblioteca criada pelo Projeto ACBr (www.projetoacbr.com.br) #
# Autor do exemplo:                                                          #
# Daniel Morais (www.linkedin.com/in/daniel-morais-infocotidiano)            # 
#----------------------------------------------------------------------------#
